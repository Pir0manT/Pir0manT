...
Меня захватывает процесс разработки и возможность создавать удобные и полезные продукты.
 В настоящее время я продолжаю развиваться в этой профессии, углубленно изучаю фреймворк Next.js, библиотеки стилий и компонентов Chakra UI, Material UI, TailwindCSS. Ежедневно практикуюсь в программировании, пишу pet-проекты, изучаю алгоритмы.
