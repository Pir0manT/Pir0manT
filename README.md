...
В настоящий момент я обучаюсь на [Веб-разработчика](https://practicum.yandex.ru/web/) в Яндекс Практикуме. Параллельно с этим углубленно изучаю фреймворк Next.js, библиотеки стилий и компонентов Bootstrap, Material UI, TailwindCSS. Ежедневно практикуюсь в программировании, пишу pet-проекты, изучаю алгоритмы.
